...
import { syncRankingWithUsers } from '../services/saudeService'; // Importar a função de sync
...
export function useLoginViewModel() {
  ...
  const signUp = useCallback(async () => {
    ...
    try {
      ...
      // 3. Sincroniza o novo usuário com a tabela de ranking
      await syncRankingWithUsers();
      console.log(`[signUp] Sincronização do ranking iniciada para o novo usuário.`);
