...
const styles = StyleSheet.create({
    ...
    recordeButton: { backgroundColor: '#005A4A', alignSelf: 'flex-start', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 15 },
    recordeButtonText: { color: '#FFFFFF', fontWeight: 'bold', fontSize: 12 },
    ...
    footerButton: { borderWidth: 1.5, borderColor: '#005A4A', borderRadius: 20, paddingVertical: 12, width: '45%', alignItems: 'center' },
    footerButtonText: { color: '#005A4A', fontWeight: 'bold' },
    editarButton: { backgroundColor: '#005A4A' },
    ...
    salvarRecordeButton: { backgroundColor: '#005A4A', padding: 15, borderRadius: 10, width: '100%', alignItems: 'center' },
