...
const styles = StyleSheet.create({
  ...
  phraseGreenLarge: { fontSize: 32, color: '#339237ff', fontWeight: '800', textAlign: 'left', lineHeight: 38 },
  ...
  statValue: { fontSize: 18, color: '#3fc271ff', fontWeight: '700' },
  ...
  infoBoxLabelColored: { color: '#2e7d32', fontWeight: '600' },
  infoBoxValue: { fontSize: 18, fontWeight: 'bold', marginTop: 5, color: '#333' },
  infoBoxValueColored: { color: '#2e7d32' },
  infoBoxGood: { backgroundColor: '#e8f5e9' },
